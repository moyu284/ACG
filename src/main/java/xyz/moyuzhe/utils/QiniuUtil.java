...
public class QiniuUtil {
     ...
     * 生成上传凭证，然后准备上传
     */
    private static String accessKey = "tks36-3zWJnKcqxeGyncbcMVhg3QtBRYYhVFA3YJ";
    private static String secretKey = "OP1T1_VzGyEavGLfUFRJCUqaU8iovTNXy5mZPK4H";
    private static String bucket = "acgbbs";
    private static String origin="http://qrz58znv6.hn-bkt.clouddn.com/";
